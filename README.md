...
[![GoDoc](https://godoc.org/github.com/DenKoren/go-jira?status.svg)](https://godoc.org/github.com/DenKoren/go-jira)
[![Build Status](https://travis-ci.org/andygrunwald/go-jira.svg?branch=master)](https://travis-ci.org/andygrunwald/go-jira)
[![Go Report Card](https://goreportcard.com/badge/github.com/DenKoren/go-jira)](https://goreportcard.com/report/github.com/DenKoren/go-jira)
...
```bash
go get github.com/DenKoren/go-jira
```
...
```bash
cd $GOPATH/src/github.com/DenKoren/go-jira
go test -v ./...
```

## API

Please have a look at the [GoDoc documentation](https://godoc.org/github.com/DenKoren/go-jira) for a detailed API description.
...
A few more examples are available in the [GoDoc examples section](https://godoc.org/github.com/DenKoren/go-jira#pkg-examples).
...
For more details have a look at the [issue #56](https://github.com/DenKoren/go-jira/issues/56).
...
Creating issues or holding talks and help other people to use [go-jira](https://github.com/DenKoren/go-jira) is contribution, too!
A few examples:

* Correct typos in the README / documentation
* Reporting bugs
* Implement a new feature or endpoint
* Sharing the love of [go-jira](https://github.com/DenKoren/go-jira) and help people to get use to it
...
[https://github.com/DenKoren/go-jira/releases/edit/v1.11.0](https://github.com/DenKoren/go-jira/releases/edit/v1.11.0)
